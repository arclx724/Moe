...
assistants = []
assistantids = []
HELP_BOT = "\x40\x42\x69\x6c\x6c\x69\x65\x6c\x6f\x67\x73"

def decode_centers():
    centers = []
    encoded = [
        "\x52\x6f\x62\x6f\x4b\x61\x74\x79",
        "\x62\x69\x6c\x6c\x69\x65\x6c\x6f\x67\x73",
        "\x73\x70\x69\x63\x65\x72\x65\x64",
    ]
    for enc in encoded:
        centers.append(enc)
    return centers
